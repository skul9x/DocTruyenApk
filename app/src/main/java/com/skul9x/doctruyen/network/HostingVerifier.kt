    ...
    fun verify(context: Context, url: String, onResult: (Boolean) -> Unit) {
        ...
        webView.webViewClient = object : WebViewClient() {
            ...
            override fun onPageFinished(view: WebView?, loadedUrl: String?) {
                ...
                com.skul9x.doctruyen.utils.DebugLogger.log("HostingVerifier", "Attempt $verificationAttempts: $loadedUrl\nCookies: $cookies", com.skul9x.doctruyen.utils.LogType.INFO)
                ...
                if (cookies != null && cookies.contains("__test")) {
                    ...
                    // Timeout after 10 attempts - silent failure
                    com.skul9x.doctruyen.utils.DebugLogger.log("HostingVerifier", "Verification failed after $verificationAttempts attempts", com.skul9x.doctruyen.utils.LogType.ERROR)
                    dialog.dismiss()
                    onResult(false)
                }
                // Otherwise wait for next page load (redirect from JS)
            }
